...
spqr_outlier_threshold=0.2
spqr_scaled_th=$(echo "$spqr_outlier_threshold * 100" | bc)
spqr_simplified_outliers=false
spqr_offload_activation=true
spqr_load='cache/spqr-'$model_name'-w'$bits_w'g'$groupsize_w'-qw'$spqr_qq_scale_bits'qg'$spqr_qq_groupsize'-t'$spqr_scaled_th
spqr_save='cache/spqr-'$model_name'-w'$bits_w'g'$groupsize_w'-qw'$spqr_qq_scale_bits'qg'$spqr_qq_groupsize'-t'$spqr_scaled_th
